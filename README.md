...
5. Apply migrations **only to a disposable local stack or an approved non-production project**:
   ...
   - Day 7 schedule automations: `supabase/migrations/20260920180000_day7_schedule_automations.sql` and `20260920181000_day7_schedule_rpcs.sql`
   - Day 8 accountant center: `supabase/migrations/20260920190000_day8_accountant_center.sql`
