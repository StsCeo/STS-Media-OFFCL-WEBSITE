...
import { IvoryShell, PageKicker, PageTitle } from "@/components/public/page-hero";
    ...
    <IvoryShell>
      ...
      {page.needsProfessionalReview ? (
        <div className="mt-6">
          ...
          <p className="mt-3 text-sm text-[#4f564f]">
      ...
      <p className="mt-10 text-sm">
        ...
        {" · "}
        <Link href="/security/vulnerabilities" className="underline">
